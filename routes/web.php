...
//Admin dashboard
    ...
    Route::get('/graph-sales-hire', [App\Http\Controllers\Admin\DashboardController::class, 'graphSalesHire']);
    Route::get('/graph-total-sales', [App\Http\Controllers\Admin\DashboardController::class, 'graphTotalSales']);
    Route::get('/graph-refund-amount', [App\Http\Controllers\Admin\DashboardController::class, 'graphRefundAmount']);
    ...
    Route::get('orders-post-add', [App\Http\Controllers\Admin\OrderController::class, 'ordersPostAdd']);
    Route::post('orders-post-add', [App\Http\Controllers\Admin\OrderController::class, 'ordersPostAdd']);
    ...
    route::get('order-history-made', [App\Http\Controllers\Admin\OrderController::class, 'orderHistoryMade']);
    ...
    route::get('/order-slip-made', [App\Http\Controllers\Admin\OrderController::class, 'orderLispMade']);
